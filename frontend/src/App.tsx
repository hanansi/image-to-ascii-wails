...
function App() {
    ...
    return (
        <main id="App" className="flex flex-col gap-4 justify-start bg-black h-screen w-screen">
            ...
            <div>
                <button className="bg-gradient-to-b from-blue-500 to-purple-500 rounded-md cursor-pointer px-2
                                    w-[25vw] min-w-[5rem] max-w-[10rem] h-[25vh]  min-h-[5rem]  max-h-[10rem]
